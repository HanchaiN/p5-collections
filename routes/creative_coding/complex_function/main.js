...
import { arctan2, complex_absSq, complex_zeta, fpart, map } from "../utils/math.js";
...
export default function execute() {
    ...
    let buffer = null;
    const R = 20;
    const l0 = Number.parseInt(getComputedStyle(document.body).getPropertyValue('--tone-surface-dim')) / 100;
    const l1 = Number.parseInt(getComputedStyle(document.body).getPropertyValue('--tone-surface-bright')) / 100;
    let i = 0;
    let j = 0;
    function f(z) {
    ...
    function setup() {
        ...
        i = 0;
        j = 0;
        ctx.fillStyle = getColor('--color-surface-container-3', "#000").formatHex8();
